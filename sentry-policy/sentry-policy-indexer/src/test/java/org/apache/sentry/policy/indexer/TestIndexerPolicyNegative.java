...
public class TestIndexerPolicyNegative {
  ...
  public void testPerDbFileException() throws Exception {
    ...
    IndexerPolicyFileBackend policy = new IndexerPolicyFileBackend(globalPolicyFile.getPath(), conf);
  ...
  public void testIndexerRequiredInRole() throws Exception {
    ...
    PolicyEngine policy = new IndexerPolicyFileBackend(globalPolicyFile.getPath(), conf);
