...
public class DBPolicyFileBackend extends SimpleDBPolicyEngine {
  ...
  @VisibleForTesting
  public DBPolicyFileBackend(String server, String resource, Configuration conf) throws IOException{
    super(server, new SimpleFileProviderBackend(conf, resource));
  }
